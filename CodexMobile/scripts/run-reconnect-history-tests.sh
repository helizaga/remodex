...
ITERATIONS="${TEST_ITERATIONS:-${ITERATIONS:-1}}"
...
XCODEBUILD_TEST_ITERATIONS="${XCODEBUILD_TEST_ITERATIONS:-${TEST_ITERATIONS:-1}}"
...
assert_positive_integer "$XCODEBUILD_TEST_ITERATIONS" "XCODEBUILD_TEST_ITERATIONS"
